...
url_xpath_kenbika1 = "/html/body/div/div/div/div/section/div/div/ul/li/a"
...
# # 最初のPR行削除
delite_line(kenbika_bukkenfile1,0)
delite_line(kenbika_urlfile1,0)
...
for i,n_file in enumerate(new_title_files):
    if not n_file in old_title_files:
        write_a(n_file + new_url_files[i],send_file)
...
from_address = my_account
to_address = "soramimiplatz@gmail.com"
subject = 'test subject'
# =====================================================================
# body(メッセージ部）を作成

with open("./data3/send_record.txt", "r") as naiyou:
    body = str(naiyou.readlines())


# =====================================================================
emailfile = "data3/send_record.txt"
# body =
...
#     line_msgs = f.readlines()
#     print(line_msgs)
#     f.close()
#     for line_msg in line_msgs:
#         write_a(line_msg, "./data3/line_msg.txt")
#     with open("./data3/line_msg.txt", "r",
#               encoding="utf-8") as ms:
#         line_honbuns = ms.readlines()
#         line_send(line_honbuns)
#
# if os.path.isfile(send_file):
#     os.remove(send_file)
...
# if os.path.isfile("data3/send_mail.txt"):
#     os.remove("data3/send_mail.txt")
